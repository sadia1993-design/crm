        ...
        <div class="col-md-5">
            <div class="card summery">
                ...
                <div class="card-body proposalInfo">
                    ...
                    <h5 class="font-weight-bold">Company Name: {{$proposal->customers->company_name}}</h5><br>
                    <p>Address: {{$proposal->customers->address}}</p>
                    <p>Phone: {{$proposal->customers->phone}}</p>
                    <p>City: {{$proposal->customers->city ? $proposal->customers->city : 'NA'}}</p>
                    <p>Country: {{$proposal->customers->country ? $proposal->customers->country: 'NA'}}</p>
                    <p>Zip: {{$proposal->customers->zip ? $proposal->customers->zip : 'NA'}}</p>
                    <p>Vat Number: {{$proposal->customers->vat_number ?$proposal->customers->vat_number : 'Not Applicable'}}</p>
                    @if ($proposal->signText)
                        <p><strong>Signature: </strong><img src="{{$proposal->signText}}" alt="" style="width:120px"></p>
                    @endif
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="" method="post" id="form-accept">
                            ...
                            <hr />
                            <div class="form-group">
                                <button type="button" class="btn btn-primary" data-id="{{$proposal->id}}" id="sig-submitBtn">Sign</button>
            ...
            <div class="btn button-list">
                ...
                <a href="{{url('proposalDownload/')}}/{{$proposal->id}}"   class="btn btn-blue btn-lg  "><i class="fas fa-download" aria-hidden="true"></i>Generate PDF</a>
