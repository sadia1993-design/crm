(function(e, d) {
        ...
        f.prototype = {
            moveBar: function(a) {
                ...
                h(function() {
                    1 === c.scrollRatio ? c.bar.classList.add("ss-hidden") : (c.bar.classList.remove("ss-hidden"),
                        c.bar.style.cssText = "height:" + 100 * c.scrollRatio + "%; top:" + c.el.scrollTop / b * 100 + "%;right:-" + (c.target.clientWidth - c.bar.clientWidth) + "px;")
                })
            }
        };
